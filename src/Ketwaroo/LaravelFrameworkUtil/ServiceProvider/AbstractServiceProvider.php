...
abstract class AbstractServiceProvider extends ServiceProvider
{
    ...
    protected function _detectPackage()
    {
        ...
        $this->_packageFullName      = Package::inWhichPackageAmI(yk_reflect($this)->getFileName());
        $this->_packageNamespaceName = yk_reflect($this)->getNamespaceName();
    ...
    {
        list($packageName, $file, $localkey) = yk_resolve_namespaced($key);
